...
""".format(otp)
    ...
    server.login('poojarsuvarna36@gmail.com', 'cxad hjvk hjyu kfzm')
...
def send_new_course_email( email_content):
    email_address = 'poojarsuvarna36@gmail.com'  # Your Gmail email address
    app_password = 'cxad hjvk hjyu kfzm'  # Your app-specific password
